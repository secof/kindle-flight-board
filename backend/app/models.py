...
class Flight(BaseModel):
    ...
    origin_city: Optional[str] = Field(default=None, description="City name for origin airport (e.g. Milan, London)")
    destination: str = Field(..., description="Destination airport code or city")
    destination_city: Optional[str] = Field(default=None, description="City name for destination airport (e.g. Bergamo, Luton)")
