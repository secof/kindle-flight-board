...
class Settings(BaseSettings):
    ...
    # Display Settings (800x600 resolution)
    BOARD_WIDTH: int = Field(default=800, description="Target image width in pixels")
    BOARD_HEIGHT: int = Field(default=600, description="Target image height in pixels")
